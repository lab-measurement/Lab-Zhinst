...
CODE:
    ...
    handle_zi_api_error(rv, "ziAPIInit");
    rv = ziAPIConnect(conn, hostname, port);
    handle_zi_api_error(rv, "ziAPIConnect");
    RETVAL = conn;
OUTPUT:
    RETVAL
...
CODE:
    ...
    handle_zi_api_error(rv, "ziAPIListImplementations");
    RETVAL = buffer;
OUTPUT:
    RETVAL
CLEANUP:
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIGetConnectionAPILevel");
    RETVAL = version;
OUTPUT:
    RETVAL
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIGetValueD");
    RETVAL = result;
OUTPUT:
    RETVAL
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIGetValueI");
    RETVAL = result;
OUTPUT:
    RETVAL
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIGetDemodSample");
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIGetDIOSample");
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIGetAuxInSample");
...
CODE:
    ...
    handle_error(conn, rv, "ziAPISetValueB");
...
CODE:
    ...
    handle_error(conn, rv, "ziAPISyncSetValueD");
    RETVAL = result;
OUTPUT:
    RETVAL
...
CODE:
    ...
    handle_error(conn, rv, "ziAPISyncSetValueI");
    RETVAL = result;
OUTPUT:
    RETVAL
...
CODE:
    ...
    int rv = ziAPISyncSetValueB(conn,  path, (uint8_t *) new_string,
                                (uint32_t *) &len, len);
    handle_error(conn, rv, "ziAPISyncSetValueB");
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIDiscoveryFind");
    RETVAL = device_id;
OUTPUT:
    RETVAL
...
CODE:
    ...
    handle_error(conn, rv, "ziAPIDiscoveryGet");
    RETVAL = props_json;
OUTPUT:
    RETVAL
